...
export const metadata: Metadata = {
  ...
  description:
    "Professional fall cleanup in Macomb County & Oakland County, MI. Leaf removal, bed cleanup & winter prep. Spots fill fast — book early. Free estimates from Tri-Point Landscaping.",
  keywords: [
