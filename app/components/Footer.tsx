        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.facebook.com/people/Tri-Point-Landscaping-LLC/61575067540062/" target="_blank" rel="noopener noreferrer" aria-label="Tri-Point Landscaping on Facebook" className="w-9 h-9 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-white/40 transition-all">
