      ...
      <div className="lg:col-span-2 flex flex-col border-r border-white/5">
        {services.map((svc, i) => (
          <button
            ...
            onClick={() => setActive(i)}
            className="text-left px-8 py-5 border-b border-white/5 group transition-all relative overflow-hidden"
            style={{
        ...
        {services.map((svc, i) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-10">
              ...
              <p className="text-white/65 text-sm leading-relaxed mb-6 max-w-md">{svc.desc}</p>
