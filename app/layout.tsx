          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              knowsAbout: [
                ...
                "Landscape Design", "Landscaping", "Landscaper", "Landscape Contractor", "Landscaping Company",
                ...
                "Commercial Landscaping", "Commercial Landscaping Company", "HOA Landscaping", "Grounds Maintenance",
                "Spring Cleanup", "Fall Cleanup",
                "Hardscaping", "Hardscaping Company", "Hardscaping Contractor", "Patio Installation",
                "Patio Contractor", "Paver Patio", "Retaining Walls", "Walkway Installation", "Fire Pits",
                "Paver Patios", "Outdoor Living Spaces",
                "Macomb County Landscaping", "Oakland County Landscaping", "Rochester Hills Lawn Care",
                "Washington Township Landscaper", "Shelby Township Landscaper", "Macomb County Landscaper",
              ],
            }),
          }}
        />
