...
const services: Record<string, ServiceData> = {
  "lawn-maintenance": {
    ...
    metaTitle: "Lawn Maintenance in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional lawn maintenance throughout Macomb County, MI — Washington Township, Shelby Township & beyond. Weekly mowing, edging, trimming & blowing from April–October. Free estimates. Call (586) 327-8080.",
    ...
    faqs: [
      ...
      { q: "What areas of Macomb County do you serve for lawn maintenance?", a: "We serve Washington Township, Shelby Township, Macomb Township, Romeo, Ray Township, Bruce Township, and surrounding areas throughout northern Macomb County." },
    ],
  ...
  "landscaping": {
    ...
    metaTitle: "Landscaping in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional landscape installation and design throughout Macomb County, MI. Planting, beds, stone features, sod & more. Free estimates. Call (586) 327-8080.",
  ...
  "mulch-and-stone": {
    ...
    metaTitle: "Mulch Installation & Decorative Stone in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional mulch installation and decorative stone throughout Macomb County, MI. Multiple mulch types, clean edging & weed control. Free estimates. Call (586) 327-8080.",
  ...
  "seasonal-cleanup": {
    ...
    metaTitle: "Spring & Fall Cleanup in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional spring and fall cleanup throughout Macomb County, MI. Leaf removal, bed clearing, debris hauling & more. Free estimates. Call (586) 327-8080.",
  ...
  "snow-removal": {
    ...
    metaTitle: "Snow Removal & Ice Management in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional snow plowing, salting & ice management throughout Macomb County, MI — Washington Township, Shelby Township & beyond. Seasonal contracts & per-push available. Call (586) 327-8080.",
  ...
  "lawn-renovations": {
    ...
    metaTitle: "Lawn Aeration, Overseeding & Renovation in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional lawn aeration, overseeding, dethatching & top dressing throughout Macomb County, MI. Transform a thin, struggling lawn into thick, healthy turf. Free estimates. Call (586) 327-8080.",
  ...
  "commercial": {
    ...
    metaTitle: "Commercial Landscaping in Macomb County, MI | Tri-Point Landscaping",
    metaDescription:
      "Professional commercial landscaping in Macomb County, MI. Mowing, trimming, cleanups, snow removal & more for offices, HOAs & retail centers. Call (586) 327-8080.",
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://tripointlandscaping.com/services/${slug}` },
    openGraph: {
      title: service.metaTitle,
      description: service.metaDescription,
