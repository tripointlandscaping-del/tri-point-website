...
const services: Record<string, ServiceData> = {
  "lawn-maintenance": {
    ...
    keywords: [
      ...
      "lawn care company Macomb County MI",
      "lawn mowing company near me Michigan",
      ...
      "grass cutting service near me Michigan",
      "lawn mowing Rochester Hills MI",
      "grass cutting Rochester MI",
      "lawn care near me Oakland County",
      "yard cutting service Macomb County",
      "turf maintenance Macomb County",
      "lawn mowing and edging Washington Township",
      "residential grass cutting near me",
      "yard care service Michigan",
      "lawn upkeep Macomb County MI",
      "lawn mowing company Washington Township",
      "lawn care company Shelby Township",
      "grass cutting company Macomb Township",
      "lawn mowing company Romeo MI",
      "lawn care company Rochester Hills MI",
      "lawn cutting company Rochester MI",
      "yard care company Ray Township MI",
      "lawn service company Bruce Township MI",
      "affordable lawn mowing Macomb County",
      "best lawn mowing company Macomb County",
      "lawn mowing cost Macomb County",
      "lawn mowing prices near me Michigan",
      "top rated lawn care Macomb County MI",
      "insured lawn care company Michigan",
      "licensed lawn care Macomb County",
      "same day lawn service Macomb County",
      "lawn mowing estimate Macomb County MI",
      "free lawn care estimate Michigan",
      "lawn mowing",
      "grass cutting",
      "lawn care",
      "lawn service",
  ...
  "landscaping": {
    ...
    keywords: [
      ...
      "landscaping contractor near me Michigan",
      "landscape contractor Macomb County",
      ...
      "residential landscaping Macomb County MI",
      "landscape renovation Washington Township",
      "yard transformation Macomb County",
      "local landscaper near me Michigan",
      "landscape makeover Macomb County",
      "outdoor landscape design Michigan",
      "landscaping company Washington Township MI",
      "landscape contractor Shelby Township",
      "landscaping company Macomb Township MI",
      "landscaping contractor Romeo MI",
      "landscape company Rochester Hills MI",
      "landscaping company Rochester MI",
      "landscape contractor Ray Township MI",
      "landscaping company Bruce Township MI",
      "affordable landscaping Macomb County MI",
      "best landscaping company Macomb County",
      "landscaping cost Macomb County",
      "free landscaping estimate Michigan",
      "top rated landscaper Macomb County MI",
      "insured landscaping company Michigan",
      "licensed landscape contractor Macomb County",
      "landscaping quotes near me Michigan",
      "overgrown yard cleanup Macomb County",
      "curb appeal improvement Michigan",
      "landscaping",
      "landscaper",
      "landscape design",
      "yard work",
  ...
  "mulch-and-stone": {
    ...
    keywords: [
      ...
      "black mulch installation Washington Township MI",
      "brown mulch service Macomb County",
      "cedar mulch near me Michigan",
      "gravel installation Macomb County",
      "landscape rock near me Macomb County",
      "flower bed mulch service Michigan",
      "garden stone installation Macomb County",
      "mulching company Washington Township MI",
      "mulch company Shelby Township MI",
      "mulch installer Macomb Township",
      "mulch company near me Romeo MI",
      "mulch delivery company Rochester Hills",
      "mulching company Rochester MI",
      "mulch installer Ray Township MI",
      "mulch company Bruce Township MI",
      "affordable mulch installation Macomb County",
      "best mulch company Macomb County MI",
      "mulch installation cost Michigan",
      "mulch prices near me Macomb County",
      "free mulch estimate Michigan",
      "black mulch near me Macomb County",
      "colored mulch company Michigan",
      "organic mulch installation Macomb County",
      "mulch and stone near me Michigan",
      "mulch installation",
      "mulching service",
      "mulch near me",
      "mulch delivery near me",
      "mulch installer near me",
      "decorative stone installation",
      "landscape rock near me",
      "mulch 48094",
      "mulch 48315",
    ],
  ...
  "seasonal-cleanup": {
    ...
    keywords: [
      ...
      "yard debris cleanup Macomb County MI",
      "property cleanup service Michigan",
      "leaf pickup service Washington Township",
      "yard waste hauling Macomb County",
      "spring yard cleanup near me Michigan",
      "fall yard cleanup service Macomb County",
      "leaf removal company Washington Township MI",
      "fall cleanup company Shelby Township",
      "spring cleanup company Macomb Township",
      "yard cleanup company Romeo MI",
      "leaf removal company Rochester Hills MI",
      "spring cleanup company Rochester MI",
      "fall cleanup company Ray Township MI",
      "cleanup company Bruce Township MI",
      "affordable fall cleanup Macomb County MI",
      "best fall cleanup company Macomb County",
      "leaf removal cost Michigan",
      "spring cleanup cost Macomb County",
      "emergency leaf removal Michigan",
      "last minute fall cleanup Macomb County",
      "same day yard cleanup Michigan",
      "yard debris removal near me Macomb County",
      "free cleanup estimate Michigan",
      "yard cleanup",
      "leaf removal",
      "spring cleanup",
      "fall cleanup",
  ...
  "lawn-renovations": {
    ...
    keywords: [
      ...
      "lawn rejuvenation Macomb County MI",
      "turf renovation Michigan",
      "lawn revival service Washington Township",
      "sod installation Macomb County",
      "lawn top dressing Michigan",
      "grass renovation service Macomb County",
      "aeration company Washington Township MI",
      "lawn renovation company Shelby Township",
      "overseeding company Macomb Township MI",
      "core aeration company Romeo MI",
      "aeration company Rochester Hills MI",
      "lawn renovation company Rochester MI",
      "overseeding company Ray Township MI",
      "aeration company Bruce Township MI",
      "affordable lawn aeration Macomb County",
      "best lawn renovation company Macomb County",
      "lawn aeration cost Michigan",
      "overseeding cost Macomb County",
      "free aeration estimate Michigan",
      "clay soil aeration Macomb County MI",
      "compacted lawn fix Michigan",
      "dead lawn restoration Macomb County",
      "thin lawn repair near me Michigan",
      "lawn aeration",
      "overseeding",
      "core aeration",
      "lawn renovation",
  ...
  "hardscaping": {
    ...
    keywords: [
      ...
      "hardscaping company Macomb County MI",
      "hardscaping contractor near me Michigan",
      "patio installation Washington Township MI",
      "patio installer near me Macomb County",
      "patio builder Macomb County MI",
      ...
      "paver patio installer near me Michigan",
      ...
      "hardscaping near me Oakland County",
      "stone patio Macomb County MI",
      "concrete patio Washington Township",
      "stamped concrete patio Michigan",
      "outdoor living area Macomb County",
      "paver walkway installation Michigan",
      "flagstone installation Macomb County",
      "backyard renovation Macomb County MI",
      "patio company Washington Township MI",
      "patio contractor Shelby Township MI",
      "retaining wall company Macomb Township",
      "hardscaping company Romeo MI",
      "patio company Rochester Hills MI",
      "patio contractor Rochester MI",
      "hardscaping contractor Ray Township MI",
      "retaining wall company Bruce Township MI",
      "affordable patio installation Macomb County",
      "best patio contractor Macomb County MI",
      "patio installation cost Michigan",
      "retaining wall cost Macomb County",
      "fire pit installation cost Michigan",
      "patio quotes near me Macomb County",
      "licensed patio contractor Michigan",
      "insured hardscaping company Macomb County",
      "free patio estimate Michigan",
      "stamped concrete vs pavers Macomb County",
      "patio installation",
      "retaining wall",
  ...
  "commercial": {
    ...
    keywords: [
      ...
      "business landscaping Macomb County MI",
      "office park grounds maintenance Michigan",
      "retail center landscaping Macomb County",
      "apartment complex landscaping Michigan",
      "facility grounds maintenance Macomb County",
      "commercial lawn mowing service Michigan",
      "commercial landscaping contract Macomb County",
      "best commercial landscaping company Michigan",
      "commercial landscaping cost Macomb County",
      "HOA board landscaping Macomb County MI",
      "facility maintenance landscaping Michigan",
      "business park landscaping Macomb County",
      "commercial snow removal contract Michigan",
      "office complex landscaping Macomb County",
      "retail plaza landscaping Michigan",
      "property management lawn service Macomb County",
      "insured commercial landscaping Michigan",
      ...
      "commercial lawn mowing near me",
      "property maintenance near me michigan",
    ],
