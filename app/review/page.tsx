      ...
      <main style={{ backgroundColor: "#0d0d0d" }}>
        ...
        <section className="py-24 px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            >
              You Made Our Day.<br />
              <span style={{ color: "#7ecb82" }}>Return the Favor?</span>
            </h1>
            <p className="text-white/55 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
              A quick Google review takes less than 60 seconds — and it helps other Macomb County homeowners find a company they can actually trust. We read every single one.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-10 py-5 text-white font-bold text-lg tracking-wide hover:opacity-90 transition-opacity mb-3"
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#111111" }}>
          <div className="max-w-xl mx-auto text-center">
            <p className="text-white/40 text-sm mb-2">Something wasn&apos;t right?</p>
            <h2
              style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}
              className="text-2xl font-bold text-white mb-4"
            >
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">
              Before leaving a negative review, please reach out directly. We&apos;re a small local business and we take every job seriously — give us the chance to fix it.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="tel:+15863278080"
                className="inline-flex items-center justify-center gap-2 bg-white text-gray-900 px-6 py-3 font-bold text-sm hover:bg-green-50 transition-colors"
              >
                Call (586) 327-8080
              </a>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 border border-white/30 text-white px-6 py-3 font-semibold text-sm hover:bg-white/10 transition-colors"
              >
                Send Us a Message
              </Link>
            </div>
